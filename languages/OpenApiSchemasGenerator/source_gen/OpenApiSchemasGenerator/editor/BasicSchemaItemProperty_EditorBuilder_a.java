...
/*package*/ class BasicSchemaItemProperty_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public BasicSchemaItemProperty_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_twfvmy_a");
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_twfvmy_a0");
  ...
  private EditorCell createConstant_1() {
    ...
    editorCell.setCellId("Constant_twfvmy_b0");
    Style style = new StyleImpl();
  ...
  private EditorCell createProperty_0() {
    ...
    try {
      final SProperty property = PROPS.type$ZAQU;
